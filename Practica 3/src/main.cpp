...
int main() {
  ...
  for (int i = 0; i < cvivas; i++) {
    cout << "Introduce el tipo de celula: ";  // Tipo de celulas vivas
    cin >> w;
    cout << "Introduce la coordenada x: ";    // Coordenada X de las celulas vivas
    cin >> x;
    cout << "Introduce la coordenada y: ";    // Coordenada Y de las celulas vivas
    cin >> y;

    cout << endl;

    T.give_life(w, x, y);                     // Damos vida a las celulas
  }
